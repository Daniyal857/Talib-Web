...
<head>
	...
	<!-- <script async src="https://www.googletagmanager.com/gtag/js?id=UA-110663194-1"></script> -->
			...
			<header class="customHeader d-flex flex-wrap justify-content-center py-3">
				<div class="container">
					<nav class="navbar navbar-expand-lg">
						...
						<a class="custom-btn primaryBackgroundColor colorWhite loginBtn" data-bs-toggle="modal" href="#loginModal" role="button">
							login
							<svg class="arrowIcon" width="12" height="10" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg">
