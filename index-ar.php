<?php
$pageClass = "homepage";
require(__DIR__ . '/views/includes/header-ar.php'); // only Header import change.
?>
            ...
            <div class="row">
                <div class="col">
                    <div class="heroInner w-75">
                        <h1 class="title colorWhite">تعرف على أفضل <span class="d-flex">المستشفيات</span></h1>
                        <p class="text colorWhite">هذا النص يمكن أن يتم تركيبه على أي تصميم دون مشكلة فلن يبدو وكأنه نص منسوخ، غير منظم، غير منسق، أو حتى غير مفهوم. لأنه مازال نصاً.</p>
                        <a href="#" class="custom-btn callBtn btn-primary primaryBackgroundColor colorWhite">اتصل بنا الآن</a>
                    </div>
                </div>
                <div class="col">
...
<section class="about-us py-5">
    <div class="container">
        <div class="row">
            <div class="col-6">
                <h2 class="title mb-3 mt-3">نبذة عنا</h2>
                <p class="desc mb-2">هذا النص يمكن أن يتم تركيبه على أي تصميم دون مشكلة فلن يبدو وكأنه نص منسوخ، غير منظم، غير منسق، أو حتى غير مفهوم. لأنه مازال نصاً بديلاً ومؤقتاً. هذا النص يمكن أن يتم تركيبه على أي تصميم دون مشكلة فلن يبدو وكأنه نص منسوخ، غير منظم، غير منسق.</p>
                <a href="<?php echo $base_url; ?>/book-appointment.php" class="custom-btn primaryBackgroundColor colorWhite mt-3 px-4 rounded-5">حجز موعد</a>
            </div>
            <div class="col-6">
                <div class="about-img">
        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <h3 class="title mb-4 mt-3">المنتجات</h3>
                    <a href="#" class="custom-btn viewAll primaryBackgroundColor colorWhite d-flex align-items-center px-3 p-1">عرض الكل
...
<section class="servicesSection">
    <div class="container px-4 py-5" id="featured-3">
        <h4 class="mb-5 title">أفضل الخدمات لك!</h4>
        <div class="row">
            <div class="col-lg-4">
...
<section class="locationSection py-5">
    <div class="container">
        <div class="d-flex align-items-center flex-column">
            ...
            <h5 class="mb-2 title">موقعنا</h5>
            <p class="desc mb-4">هذا النص يمكن أن يتم تركيبه على أي تصميم دون مشكلة فلن يبدو وكأنه نص منسوخ، غير منظم.
            </p>
        </div>
